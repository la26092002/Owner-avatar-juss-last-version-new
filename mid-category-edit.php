...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La catégorie de niveau intermédiaire est mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Tout Voir</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <button type="submit" class="btn btn-success pull-left" name="form1">Mise a Jour</button>
                    </div>
                </div>
