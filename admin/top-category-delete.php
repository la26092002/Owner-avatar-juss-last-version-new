...
// Check if $p_ids is set and is an array before using count()
if (isset($p_ids) && is_array($p_ids)) {
    ...
    // Handle the case where $p_ids is not set or is not an array
    echo "Error: \$p_ids is not defined or not an array.";
}
