...
<section class="content-header">
    <div class="content-header-left">
        <h1>Ajouter Les Frais De Port</h1>
    </div>
</section>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Sélectionnez le Pays <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Voir Les Frais D'Expédition</h1>
	</div>
</section>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Frais de port (Reste du monde)</h1>
    </div>
</section>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"></label>
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success pull-left" name="form2">Mise à Jour</button>
                            </div>
                        </div>
                    </div>
                </div>
