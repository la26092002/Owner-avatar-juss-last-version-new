...
if(isset($_POST['form2'])) {
    ...
    if($path == '') {
        $valid = 0;
        $error_message .= 'Vous devez avoir à sélectionner une photo<br>';
    } else {
        $ext = pathinfo( $path, PATHINFO_EXTENSION );
        $file_name = basename( $path, '.' . $ext );
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
...
if(isset($_POST['form3'])) {
    ...
    $success_message = 'Les paramètres généraux du contenu sont mis à jour avec succès.';
...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Les informations sur les paramètres du formulaire de contact sont mises à jour avec succès.';
}
...
if(isset($_POST['form5'])) {
    ...
    $success_message = 'Les paramètres de la barre latérale sont mis à jour avec succès.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Les paramètres Marche-arrêt de la section sont mis à jour avec succès.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Les paramètres de la méta daccueil sont mis à jour avec succès.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_title'])) {
        $valid = 0;
        $error_message .= 'Le titre de lappel à laction ne peut pas être vide<br>';
    }

    if(empty($_POST['cta_content'])) {
        $valid = 0;
        $error_message .= 'Le contenu de lappel à laction ne peut pas être vide<br>';
    }

    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Appel à laction Lire la suite Le texte ne peut pas être vide<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'Appel à laction En savoir plus URL ne peut pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données dappel à laction sont mises à jour avec succès.';
...
if(isset($_POST['form6_4'])) {
    ...
    if(empty($_POST['featured_product_title'])) {
        $valid = 0;
        $error_message .= 'Le titre du produit vedette ne peut pas être vide<br>';
    }

    if(empty($_POST['featured_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre du produit vedette ne peut pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données du produit vedette sont mises à jour avec succès.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'Le dernier titre du produit ne peut pas être vide<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre du dernier produit ne peut pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les dernières données produit sont mises à jour avec succès.';
...
if(isset($_POST['form6_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données sur les produits populaires sont mises à jour avec succès.';
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de connexion est mise à jour avec succès.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page dinscription est mise à jour avec succès.';
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page doubli du mot de passe est mise à jour avec succès.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de réinitialisation du mot de passe est mise à jour avec succès.';
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de recherche est mise à jour avec succès.';
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page du panier est mise à jour avec succès.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de paiement est mise à jour avec succès.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de catégorie de produit est mise à jour avec succès.';
...
if(isset($_POST['form9'])) {
    ...
    $success_message = 'Les paramètres de paiement sont mis à jour avec succès.';
}
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Le script de tête et de corps est mis à jour avec succès.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Icône de Favori</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Mise a jour Logo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Mise a jour Favicon</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Section Bulletin d'Information </label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contact de Telephone </label>
                                        <div class="col-sm-6">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form3">Mise a jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact Address Email </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact Email Message de remerciement</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="receive_email_thank_you_message"><?php echo $receive_email_thank_you_message; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Message d'oubli de mot de passe</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-success pull-left" name="form4">Mise a jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (Combien de derniers produits?)<span>*</span></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form5">Mise à Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des Produits Vedettes </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Dernière Section de Produits </label>
                                        <div class="col-sm-4">
                                   ...
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_0">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Description Meta </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Section des Produits Vedettes</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du Produit Vedette<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="featured_product_title" value="<?php echo $featured_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre du Produit vedette<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_4">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Dernier Titre De Produit<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_5">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre de Produit Populaire<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="popular_product_title" value="<?php echo $popular_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre de Produit Populaire<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_6">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Section Bulletin d'Information</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_3">Mise a Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de Page D'Oubli de Mot de Passe Existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Modifier la Bannière de la Page D'Oubli du Mot de Passe</h4>
                                        Sélectionner une Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de Page De Réinitialisation de Mot De Passe Existante</h4>
                                        <p>
                                    ...
                                    <div class="box-body">
                                      ...
                                      <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form9">Mise a Jour</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="tab_10">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Code avant &lt;/head&gt; tag </label>
                                            <div class="col-sm-8">
                                                <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Code aprés &lt;body&gt; tag </label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form10">Mise a Jour</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
