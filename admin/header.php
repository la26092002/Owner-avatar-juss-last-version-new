						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									...
									<div>
										<a href="logout.php" class="btn btn-default btn-flat">Déconnectez</a>
									</div>
								</li>
							</ul>
						</li>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                     ...
                     <li class="treeview <?php if( ($cur_page == 'slider.php') ) {echo 'active';} ?>">
			          <a href="slider.php">
			            <i class="fa fa-picture-o"></i><span>Gérer les diaporamas</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'service.php') ) {echo 'active';} ?>">
			          ...
			          <a href="faq.php">
			            <i class="fa fa-question-circle"></i><span>Questions Fréquemment Posées</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'page.php') ) {echo 'active';} ?>">
			          <a href="page.php">
			            <i class="fa fa-tasks"></i><span>Paramètres de la Page</span>
			          </a>
			        </li>
					...
					<li class="treeview <?php if( ($cur_page == 'language.php')||($cur_page == 'language.php') ) {echo 'active';} ?>">
			          <a href="language.php">
					  <i class="fa fa-cog" aria-hidden="true"></i><span>langue</span>
			          </a>
			        </li>
