...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Super Admin') {
	    ...
	    if(empty($_POST['email'])) {
	        $valid = 0;
	        $error_message .= 'Ladresse e-mail ne peut pas être vide<br>';
	    } else {
	    	if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) {
		        $valid = 0;
		        $error_message .= 'Ladresse e-mail doit être valide<br>';
		    } else {
		    	...
		    	if($total) {
		    		$valid = 0;
		        	$error_message .= 'Ladresse e-mail existe déjà<br>';
		    	}
		    }
	    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La photo de lutilisateur est mise à jour avec succès.';
...
if(isset($_POST['form3'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Le mot de passe de lutilisateur est mis à jour avec succès.';
    }
}
?>
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Retapez le Mot de Passe </label>
										<div class="col-sm-4">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Mise a Jour Mot de Passe</button>
										</div>
									</div>
								</div>
							</div>
