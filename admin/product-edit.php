                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" style="padding-top:4px;">
                                <?php if(!empty($p_featured_photo)): ?>
                                    ...
                                    <button type="submit" name="delete_photo" class="btn btn-danger btn-xs" onclick="return confirm('Voulez-vous vraiment supprimer cette photo?');">Supprimer la Photo</button>
                                <?php else: ?>
