...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Le nom de la catégorie supérieure ne peut pas être vide<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Le nom de la catégorie supérieure existe déjà<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La catégorie supérieure est mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier la Catégorie de Niveau Supérieur</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Tout Voir</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nom De Catégorie de Niveau Supérieur <span>*</span></label>
                    <div class="col-sm-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Supprimer Confirmation</h4>
            </div>
