...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_end_category (ecat_name, mcat_id, tcat_id) VALUES (?, ?, ?)");
		$statement->execute(array($_POST['ecat_name'], $_POST['mcat_id'], $_POST['tcat_id']));
