...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'La photo est ajoutée avec succès.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Tout Voir</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Télécharger une Photo <span>*</span></label>
