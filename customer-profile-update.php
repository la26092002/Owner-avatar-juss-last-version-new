...
@media (max-width: 768px) {
  ...
  .img-box {
	...
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Mettre a Jour Info - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-password-update.php') {
		?>
		<title>Mettre a Jour le Mot de Paas - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
		...
		// Vérifie si 'cust_state' existe dans $_POST pour éviter l'erreur
		$cust_state = isset($_POST['cust_state']) ? $_POST['cust_state'] : '';
	
		// update data into the database
		$statement = $pdo->prepare("UPDATE tbl_customer SET cust_name=?, cust_phone=?, cust_address=?, cust_state=? WHERE cust_id=?");
